...
int main()
{
  ...
  std::cout << "\nThe floating point loses much more precision than the double." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nThe floating point loses so much precision that it outputs only zeros." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nThe double is still displaying numbers while the floating point just outputs inf instead of numbers." << std::endl;
